...
export class Session {
     ...
     */
    morphFrames() {
        const ret = wasm.session_morphFrames(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    renderMorph(n) {
        ...
        let deferred1_1;
        try {
            const ret = wasm.session_renderMorph(this.__wbg_ptr, n);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    renderStep(n) {
        ...
        let deferred1_1;
        try {
            const ret = wasm.session_renderStep(this.__wbg_ptr, n);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    summary() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.session_summary(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('elfa_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
